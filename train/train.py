...
class Train:
    def __init__(self, id, carriages: list[Cariage], routes: list[Routes], initiatin=True):
        self.id = id
    ...
    def book_seat_for_route(self, starting_station, destination_station, carriage_id, seat_id, route_id, data):
    ...
    def list_all_availabe_seats(self, starting_station, destination_station, route_id, r_data={}):
        ...
        for key in self.carriages:
            avalibe_seats = self.carriages[key].list_all_availabe_seats(starting_station, destination_station, route_id, r_data)
